...
function Accpriv() {
  return (
    <>
    <div className="accpriv">
        <h3 id="privpolicyhead">Account privacy and policy</h3>
        <p id="privpolicy">We i.e. "Blink Commerce Private Limited", are committed to protecting the privacy and security of your personal information. Your privacy is important to us and maintaining your trust is paramount.
